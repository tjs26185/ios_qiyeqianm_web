...
$codepay_config['gateway'] = isHTTPS() ? "https://codepay.fateqq.com:51888" : "http://api2.fateqq.com:52888";  //设置支付网关域名
...
$codepay_config['qrcode_url'] =''; //本地二维码控制器  用于二维码上传到本地交给这个PHP去控制

//二维码本地实现 传入http://域名/codepay/qrcode.php 会加载http://域名/codepay/qrcode.php?money=1&tag=0&type=1
// qrcode.php 为我们的演示控制二维码程序 删除下行注释【//】可以启用本地二维码 二维码上传至qr 目录下的1 2 3 里面有文件名格式说明
