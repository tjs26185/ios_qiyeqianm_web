...
$codepay_config['go_time'] = 1; //3秒跳转页面 默认为首页

$codepay_config['go_url'] =  $_SERVER[''] == '80' ? '/' : '//'.$_SERVER['SERVER_NAME'].'/index.php/home'; 
...
define('DB_USER', 'ff_98dyy_cn');  //数据库用户名
define('DB_PWD', 'ff_98dyy_cn');//数据库密码
define('DB_NAME', 'ff_98dyy_cn');  //数据库名称
