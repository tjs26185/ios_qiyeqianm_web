			...
			<div class="con">
				<div class="common">
					...
					<ul class="clearfix list1">
						...
						<div class="fl left">
							<div class="text1">企业签名</div>
							<div class="text2">月套餐</div>
						</div>
						<div class="fr right">150<span>元</span></div>
						...
						<div class="fl left">
							<div class="text1">企业签名</div>
							<div class="text2">季套餐</div>
						</div>
						<div class="fr right">400<span>元</span></div>
						<span class="radio-checked icon icon-checkbox"></span>                          
						...
						<div class="fl left">
							<div class="text1">企业签名</div>
							<div class="text2">年套餐</div>
						</div>
						<div class="fr right">1000<span>元</span></div>
						<span class="radio-checked icon icon-checkbox"></span>                        
				...
				<div class="common">
					...
					<ul class="clearfix list2">
						...
						<input type="hidden" name="user" id="user" placeholder="用户名" value="">
						</li>
					</ul>
				</div>
				<div class="common">
				...
				<div class="pay-money">
					<div class="money">应支付<span>￥150</span></div>
...
<script>
    ...
    $(function () {
        ...
        $(".list1").on('click', "li", function () {
            ...
            if(service_id=='1'){
                	$(".money span").text('￥' + 150);
                	$(".list2 li.active input[name='price']").val(150);
                }else if(service_id=='2'){
                	$(".money span").text('￥' + 400);
                	$(".list2 li.active input[name='price']").val(400);
                }else if(service_id=='3'){
                	$(".money span").text('￥' + 1000);
                	$(".list2 li.active input[name='price']").val(1000);
                }
            /*
			...
			$.ajax({
				...
				success: function (result) {
					...
					*/
					...
					form.append($("<input type='hidden' name='param' value='aid' />"));
					form.appendTo("body");
					form.submit();
					setTimeout(function(){
