...
<html lang="zh_CN"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title><?php echo IN_NAME; ?>  -  免费应用分发托管平台|苹果签名|超级签名|IOS应用内测分发|Android应用内测分发|企业签名|网页一键封装|免费分发平台</title>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbar">
          <ul class="navbar-nav">
            ...
            <li><a class="nav-link" href="/source/template/pc/moban3/index.php">超级签名</a></li>  
            <li><a class="nav-link" href="/index.php/about">关于我们</a></li> 
            <li><a class="nav-link" href="/index.php/utils">工具箱</a></li> 
            <?php if($GLOBALS['userlogined']){ ?>
			<li><a class="nav-link" href="<?php echo IN_PATH.'index.php/apps'; ?>">用户中心</a> </li>
			<?php }else{ ?>             
          ...
          <div class="row align-items-center justify-content-center">
            <div class="col-md-5 order-md-2 sm-m-30px-b">
              <div class="feature-box-04">
                ...
                <a href="/index.php/apps" class="m-btn m-btn-theme">立即签名</a>
              </div>
            </div>
